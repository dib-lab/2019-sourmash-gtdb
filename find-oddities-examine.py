...
def main():
    ...
    for row in r:
        ...
        for alignment in alignments:
            if alignment.hit_length_qry >= 500 and alignment.percent_identity >= 95.0:
#                print(alignment.hit_length_qry, alignment.percent_identity)
                sum_bp += alignment.hit_length_qry
        print(cluster_name, sum_bp, 500, 95.0)
